...
public class DepartmentHeadUser extends User {

	public DepartmentHeadUser(int id, EmployeeDAO eDAO, EventDAO evtDAO, ReimbursementDAO rDAO) {
		super(id, eDAO, evtDAO, rDAO);
		this.rList=rDAO.getReimbursementByDepartment(id);
	}
	...
	public boolean approveRequest(int id) {
		return rDAO.updateReimbursementStatus(id, 3)>0;
	}
