...
public class SupervisorUser extends User {
	...
	public SupervisorUser(int id, EmployeeDAO eDAO, EventDAO evtDAO, ReimbursementDAO rDAO) {
		super(id, eDAO, evtDAO, rDAO);
		this.rList=rDAO.getReimbursementBySupervisor(id);
	}
	...
	public boolean approveRequest(int id) {
		return rDAO.updateReimbursementStatus(id, 2)>0;
	}
